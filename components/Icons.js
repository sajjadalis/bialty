...
export const Block = {
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16"><g fill="none"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-2 0c0-1.296-.41-2.496-1.11-3.477l-8.367 8.368A6 6 0 0 0 14 8zm-2.524-4.89a6 6 0 0 0-8.367 8.367l8.368-8.368z" fill="currentColor"></path></g></svg>
  `,
};
...
export const BoltIcon = {
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24"><path d="M13 3v7h6l-8 11v-7H5l8-11" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
  `,
};
